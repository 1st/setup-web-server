...
> **NOTE.** You can use a script [fabfile.py](fabfile.py) that allows you to run command `fab init_server` to install all required packages on your new Ubuntu server. *This script is under development.*
